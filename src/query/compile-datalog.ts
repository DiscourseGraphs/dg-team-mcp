// COPY from apps/roam/src/utils/compileDatalog.ts

import type { DatalogArgument, DatalogBinding, DatalogClause, DatalogSrcVar } from "./types.js";
...
const compileDatalog = (
  d: DatalogClause | DatalogArgument | DatalogBinding | DatalogSrcVar,
  level = 0,
): string => {
  switch (d.type) {
    case "data-pattern":
